...
class AtkTable extends Component {
  state = {
    modelData: [],
    editingKey: '',
    adding: false
    ...
    fetch(`${BACKEND_URL}/atk/all`, {
      ...
      .then(async (data) => {
        ...
        if (data.error) {
          ...
          this.setState({
            modelData: data.atk.sort((a, b) => a.id - b.id).map(atk => {
              return {
                ...atk,
                key: atk.id
              }
    ...
    fetch(`${BACKEND_URL}/atk/create/`, {
      ...
      .then((data) => {
        if (data.error) {
          ...
          this.setState({
            modelData: [...this.state.modelData, {...data.atk, key: data.atk.id}],
            adding: false
          });
        }
      })
...
export default connect(mapStateToProps)(AtkTable);
