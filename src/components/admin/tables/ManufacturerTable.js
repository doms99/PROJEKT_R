...
class ManufacturerTable extends Component {
  ...
  componentDidMount() {
    fetch(`${BACKEND_URL}/manufacturer/all`, {
      headers: {
      ...
      .then(async (data) => {
        ...
        if (data.error) {
          ...
          this.setState({
            modelData: data.manufactrers.sort((a, b) => a.id - b.id).map(man => {
              return {
                ...man,
                key: man.id
              }
  ...
  deleteHandler = (row) => {
    fetch(`${BACKEND_URL}/manufacturer/${row.id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${this.props.token}`,
  ...
  save = async (key) => {
    ...
    fetch(`${BACKEND_URL}/manufacturer/edit/${id}`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${this.props.token}`,
  ...
  add = async (values) => {
    ...
    fetch(`${BACKEND_URL}/manufacturer/create/`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${this.props.token}`,
        "Content-Type": "application/json",
      ...
      .then((data) => {
        if (data.error) {
          ...
          this.setState({
            modelData: [...this.state.modelData, {...data.manufacturer, key: data.manufacturer.id}],
            adding: false
          });
        }
      })
...
export default connect(mapStateToProps)(ManufacturerTable);
